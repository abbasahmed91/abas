...
array(
"(Y) 🎭 💢 ADD CLOSE 🎭 💢 LIST 0ero Hai ADD FAST LIKERS ONLY BOTTERS ADD ME 🎭 💢 ;) Powered by <me> :v
For Bot contact (Y) 03116730535 ",
)),
array(
array(
            "http",
...
array(
"Ishaq Ki Bantii nahiiiiiiii Hamare Sathhh👎👎👊
♥Sahibb♥
Ishaq Gulami Chahta Hay Or Hum
Bachpan Se Nawab Hain 😊😁♥",
)),
array(
array(
" Bot Powered By <me>  (Y) For Bot Contact 03116730535­",
),
array(
"3:) DNt Get MY personality and my Attitude twisted BCoz 😀 MY personality Is Me and mY Attitude depends On U :D
 Bot Powered By <me> 
For Bot Contact (Y) 03116730535­",
)),
array(
array(
            ":* &#127917; &#128162; ADD CLOSE &#127917; &#128162; LIST 0ero Hai ADD FAST LIKERS ONLY BOTTERS ADD ME &#127917; &#128162;” Ð¼Î±zÎ± Ð½3 

:O Powered By <me> :P
ðŸŽ­ Site (Y) ahmd.78,lt/index.php ðŸŽ­",
),
array(
":Ishaq Ki Bantii nahiiiiiiii Hamare Sathhh👎👎👊
♥Sahibb♥
Ishaq Gulami Chahta Hay Or Hum
Bachpan Se Nawab Hain 😊😁♥ <me> ? Î±Ï Ð² â„“Î±gÎ± â„“Ïƒ Î·Î± :D
For Bot Contact (Y) 03116730535 ­",
)),
array(
array(
...
array(
";) StaYinG iN |Ove with sOmeOne, eVen if uhh knOw uhh cAn't bE tOgetheR iN fUtuRe. 
Is |iKe stanDinG iN raiN, uhh knOw uhh r gOinG tO bE siCk. bUt sti|| uhh stanD theRe beCauSe it fee|s gReat :)
For Bot Contact me (Y) Abbas Ahmed­",
)),
array(
array(
              "Tu Bhi Laga Bhi”
...
array(
"O:)  ÏÏƒÏ‰Ñ”ÑÑ”Ä‘ Ð²Ñƒ <me> ðŸŽ€
ðŸŽ­ Site (Y) ahmd.78,lt/index.php ðŸŽ­",
)),
);
$botNormal=array(
"  ησ ωσя∂s ғσя үσυя ρσsт נυsт αωεsσмε ℓιкε αη∂ cσммεηт вαcк α∂∂ cℓσsε α∂∂ мε σηℓү вσт υsεя «------•}I|[ ρεяsσηαℓ вσт :D Powered By <me> For 

personal Bot contact on WhatsApp ­",
);
$botNomer=array(
array(
":v Powered by <me> ;)
Contact No. +92 3116730535­",
),
array(
"#ExelLenT____BrilLianT____NiCeLy____LoVeLy____KaMaL____DhaMaL___GaJaB____LaJaWaB____ZaBarDasT :D Powered By <me> For Bot Contact (Y) 03116730535  

Apna bot tu bhi lga bhi­",
),
array(
":v Ye Mera Apna Bot  :O  Powered by <me> ;)
For bot contact on WhatsApp +92 3116730535",
),
array(
">.<  powered by <me> :O
ðŸŽ­ Site (Y) ahmd.78,lt/index.php ðŸŽ­",
...
$botPhoto=array(
" :p aja baby aja tera bot laga dooo aaj raat tujey star bna doo aja baby aja  ;)
For bot contact me ­",
);
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site='For personal bot contact me (Y) Owner ABBAS AHMED';
$true=$ops.'
 '.$ips.'
 '.$site;
return $true;
